<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="FrmAgentProfile.aspx.cs" Inherits="S_FACTOR_VMS.FrmAgentProfile" %>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-25">
                                ...
                                <asp:TextBox ID="TxtPAN" CssClass="form-control mb-2" runat="server" style="text-transform: uppercase" ReadOnly="true"></asp:TextBox>
